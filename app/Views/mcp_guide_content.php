    ...
    "openchat-graph": {
      "serverUrl": "https://openchat-review.me/mcp"
                ...
                <ul>
                    ...
                    <li>サイト内のコメントや、個人情報を含むデータは<b>取得できません</b>（部屋の統計データのみ公開しています）。</li>
                    <li><b>利用回数の制限はありません</b>（何回でも無料で使えます）。アクセスが同じ瞬間に集中したときだけ「少し待って再試行して」という応答になることがありますが、AIが自動で再試行するので気にしなくて大丈夫です。</li>
