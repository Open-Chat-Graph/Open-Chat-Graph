...
<script>
    tailwind.config = {
        // サイトのテーマ切替（public/js/theme.js が html[data-theme] を常時設定）に連動
...
<?php
/** トレンド値に応じた色クラスを返す */
function trendColorClass(int $value, string $positiveClass = 'text-emerald-600 dark:text-emerald-400', string $negativeClass = 'text-rose-600 dark:text-rose-400'): string
{
