-- Schema for database: ocgraph_commentth
-- Extracted from: ocgraph_commentth.sql
-- Generated: Mon Jan 12 01:35:53 JST 2026

CREATE DATABASE IF NOT EXISTS `ocgraph_commentth` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `ocgraph_commentth`;
