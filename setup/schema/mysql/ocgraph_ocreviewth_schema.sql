-- Schema for database: ocgraph_ocreviewth
-- Extracted from: ocgraph_ocreviewth.sql
-- Generated: Mon Jan 12 01:35:55 JST 2026

CREATE DATABASE IF NOT EXISTS `ocgraph_ocreviewth` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `ocgraph_ocreviewth`;
